...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./1-CSHOgLa9.js')),
			__memo(() => import('./2-Cbt1FwHB.js')),
			__memo(() => import('./3-DoGzxGw6.js')),
			__memo(() => import('./4-DPLiPzcU.js')),
			__memo(() => import('./5-D3FPUG8y.js')),
			__memo(() => import('./6--zCNyKAY.js')),
			__memo(() => import('./7-B4ZLYOw3.js')),
			__memo(() => import('./8-BFQGLnSm.js')),
			__memo(() => import('./9-DCQACsiD.js')),
			__memo(() => import('./10-D_okE1ZL.js')),
			__memo(() => import('./11-DU6UnbXz.js')),
			__memo(() => import('./12-vI7q6V5z.js')),
			__memo(() => import('./13-D3dcY1os.js')),
			__memo(() => import('./14-Bgscfiuj.js')),
			__memo(() => import('./15-CnQlOrMZ.js')),
			__memo(() => import('./16-Dd1Nqw4J.js')),
			__memo(() => import('./17-DvfgA-bI.js')),
			__memo(() => import('./18-BvZGZp-m.js')),
			__memo(() => import('./19-pTz7QZcV.js')),
			__memo(() => import('./20-D9Hc9V0K.js'))
		],
		remotes: {
...
//# sourceMappingURL=manifest.js-XDumM2Qm.js.map
