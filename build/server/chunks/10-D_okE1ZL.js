...
const index = 10;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-BhRUC8zB.js')).default;
const universal_id = "src/routes/(client)/struktur-organisasi/+page.js";
const imports = ["_app/immutable/nodes/10.qFa7P8kf.js","_app/immutable/chunks/B8o_ubcR.js","_app/immutable/chunks/xihTtKlq.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, stylesheets, _page as universal, universal_id };
//# sourceMappingURL=10-D_okE1ZL.js.map
