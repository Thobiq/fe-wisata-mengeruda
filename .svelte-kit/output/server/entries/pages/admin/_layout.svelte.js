...
import { T as escape_html, a as ensure_array_like, c as store_get, f as html, i as derived, t as attr_class, u as unsubscribe_stores, w as attr } from "../../../chunks/server.js";
/* empty css                  */
...
function _layout($$renderer, $$props) {
  ...
  `, "svelte-1qg5d05")}><div class="flex items-center gap-3 px-6 py-8 border-b border-[#2C2520]"><div class="w-10 h-10 bg-gradient-to-br from-[#E2C37A] to-[#B68D37] rounded-xl flex items-center justify-center shrink-0 shadow-lg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-[#161311]"><path fill-rule="evenodd" d="M14.615 1.595a.75.75 0 01.359.852L12.982 9.75h7.268a.75.75 0 01.548 1.262l-10.5 11.25a.75.75 0 01-1.272-.71l1.992-7.302H3.75a.75.75 0 01-.548-1.262l10.5-11.25a.75.75 0 01.913-.143z" clip-rule="evenodd"></path></svg></div> <div><h2 class="font-serif font-bold text-white text-[16px] tracking-wide">Tourism Admin</h2> <p class="text-[12px] text-[#C79F44] font-medium">Desa Mengeruda</p></div></div> <nav class="flex-1 px-4 space-y-1.5 overflow-y-auto mt-6 custom-scrollbar svelte-1qg5d05"><div class="text-[10px] font-bold text-[#6D5D51] uppercase tracking-widest px-4 mb-3">Menu Utama</div> <!--[-->`);
